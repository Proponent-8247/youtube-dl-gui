...
| DH-A061 | High | Fixed / regression-verified | Protected filename schemas must end in an active `.%(ext)s`, keeping new media physically inventoryable and preserving the A057 in-tree `.txt` archive separation. |
