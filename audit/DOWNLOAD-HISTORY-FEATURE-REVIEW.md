...
| DH-A061 | High | Reopened / repair pending | Common protected validation is fixed, but the extended downloader validates before applying its pre-existing terminal `.%(ext)s` normalization. |
