...
| DH-A056 | High | Verified / repair pending | Playlist/multi-video `.info.json` can be misused as completed-media identity, while same-stem media-like playlist thumbnails are counted as unresolved media. |
